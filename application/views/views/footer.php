        ...
        <?php if($page == "Data Pendaftaran Tugas Akhir"){?>
            ...
            if("<?= $periode["periode_progress"]?>"=="Validasi"){
                $('#view-daftar').on('hidden.bs.modal', function () {
                            ...
                            render: function(data, type, row) {
                                ...
                                if(row["periode"]=="Validasi"){
                                    if(row["ta_progres"]=="Ditolak"){
                                        html_button += 
                                        "<a onclick='viewdaftar(`"+data+"`)' data-toggle='modal' data-target='#view-daftar' class='btn btn-sm btn-outline-primary btn-danger'><i class='fa fa-times text-light'></i> <i class='far fa-eye text-light'></i></a>";
                                    }else{
                                        html_button += 
                                        "<a onclick='viewdaftar(`"+data+"`)' data-toggle='modal' data-target='#view-daftar' class='btn btn-sm btn-outline-primary btn-warning'><i class='fa fa-question text-light'></i> <i class='far fa-eye text-light'></i></a>";
                                    }

                                    if(row["ta_lihat_koordinator"]=="True"){
                                        html +=  "<div class='ribbon ribbon-modern ribbon-primary border border-secondary rounded'>"+
                                                            "<div class='ribbon-box font-w300'>Dibuka"+
                                                            "</div>"+
                                                            "<div class='text-center pt-5 m-1'>"+
                                                                "<h4 class='mb-0'>"+html_button+"</h4>"+
                                                            "</div></div>";
                                    }else{
                                        html += html_button;
                                    }
                        ...
                        "columns": [
                            ...
                            },
                            {
                                ...
                                render: function(data, type, row) {
                                    ...
                                    let html = "";
                                    if(data=="Diajukan"){
                                        html_button += "<a onclick='viewdaftar(`"+row["ta_id"]+"`,"+<?= $tipe?>+")' data-toggle='modal' data-target='#view-daftar' class='btn btn-sm btn-outline-primary btn-warning'><small><i class='fa fa-question mr-1 text-light'></i></small><i class='far fa-eye text-light'></i><br></a>";
                                    }else if(data=="Diterima"){
                                        html_button += "<a onclick='viewdaftar(`"+row["ta_id"]+"`,"+<?= $tipe?>+")' data-toggle='modal' data-target='#view-daftar' class='btn btn-sm btn-outline-primary btn-success'><small><i class='fa fa-check mr-1 text-light'></i></small><i class='far fa-eye'></i></a>";
                                    }else{
                                        html_button += "<a onclick='viewdaftar(`"+row["ta_id"]+"`,"+<?= $tipe?>+")' data-toggle='modal' data-target='#view-daftar' class='btn btn-sm btn-outline-primary btn-danger'><small><i class='fa fa-times mr-1 text-light'></i></small><i class='far fa-eye'></i></a>";
                                    }
                                    if(row["ta_lihat_pembimbing"+"<?= $tipe?>"]=="True"){
                                        html +=  "<div class='ribbon ribbon-modern ribbon-primary border border-secondary rounded'>"+
                                                            "<div class='ribbon-box font-w300'>Dibuka"+
                                                            "</div>"+
                                                            "<div class='text-center pt-5 m-1'>"+
